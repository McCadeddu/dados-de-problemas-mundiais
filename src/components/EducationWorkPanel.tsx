export function EducationWorkPanel({ themeId }: { themeId: string }) {
  ...
  return <section className="panel">
    ...
    <div className="hunger-water-panel__grid">
      ...
      <article><h4>Emprego vulnerável</h4><p>O indicador mundial da OIT mede trabalhadores por conta própria e trabalhadores familiares auxiliares como percentual do emprego total. É um sinal de vulnerabilidade ocupacional, não uma contagem de pessoas sem contribuição.</p><p className="meta"><a href="https://data.worldbank.org/indicator/SL.EMP.VULN.ZS">OIT/ILOSTAT via Banco Mundial</a>.</p></article>
    ...
    <p>A comparação abaixo reúne trabalho e migração por país e ano, com as populações de referência explicitadas. A associação observada não demonstra que a migração cause desemprego ou exploração.</p>
  </section>
}
